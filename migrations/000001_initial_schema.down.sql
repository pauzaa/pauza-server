...
DROP INDEX IF EXISTS idx_sync_tombstones_user_cursor;
DROP INDEX IF EXISTS idx_sync_tombstones_user_time;
DROP INDEX IF EXISTS idx_device_tokens_user;
DROP INDEX IF EXISTS idx_friendships_user_pair;
DROP INDEX IF EXISTS idx_friendships_requester;
DROP INDEX IF EXISTS idx_friendships_addressee;
DROP INDEX IF EXISTS idx_admin_entitlement_overrides_active;
DROP INDEX IF EXISTS idx_admin_entitlement_overrides_user;
...
DROP INDEX IF EXISTS idx_otp_failed_attempts_email_purpose_attempted_at;
...
DROP TABLE IF EXISTS admin_entitlement_overrides CASCADE;
...
DROP FUNCTION IF EXISTS set_server_deleted_at_bigint() CASCADE;
DROP FUNCTION IF EXISTS set_server_created_at_bigint() CASCADE;
DROP FUNCTION IF EXISTS set_server_updated_at_bigint() CASCADE;
